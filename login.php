...
<body>
    ...
    <div class="wrapper">
        ...
        <form method="POST" action="verlogin.php">
            ...
            <div class="input-box">
                <input type="email" placeholder="Email" required class="name" name="email" required>
            ...
            <h4>Mot de Passe</h4>
            <div class="input-box">
                <input type="password" placeholder="Mot de Passe" required class="name" name="mot" required>
                <i class="fas fa-lock icon"></i>
            </div>
            <br>
            <div class="input-box">
                <button type="submit">Connecter</button>
                <a href="404.php">Créer un compte</a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="motoublie.php">Mots de passe oublier?</a>
            </div>
