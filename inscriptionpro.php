...
<head>
    <meta charset="utf-8">
    <title>Rento - Inscription/professionnel</title>
                    ...
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item"><a href="inscriptionpro.php">Professionnel</a></li>
            ...
            <div class="booking p-5">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        <h4 class="text-white mb-4">Vous êtes loueur professionnel?</h4>
                        <p class="mb-4"> Dans votre boutique, vous obtenez tous ces avantages: </p>
                        <ul>
                            <li>Une boutique ouvert 24h/24h.</li>
                            <li>Forte Visibilité: réferencez vos Biens dans la 1ère et unique Market-place de location au Maroc.</li>
                            <li>Une vitrine personnalisée professionnel de votre marque dans les listes de Rento Pro et Gratuit .</li>
                        </ul>
                        <h4 class="text-white mb-4">Attention!!</h4>
                        <p class="mb-4">Choisi trés bien le domaine d'activité pour référencer votre boutique</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="ajouterpro.php" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-control bg-transparent" name="domaine" required>

                                            <option>Immoubiliers</option>
                                            <option>outillages</option>

                                            <option>Outils événementiels</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" name="raison" placeholder="facebook" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" name="logo" accept="image/png, image/jpeg, image/jpg, image/gif">
                                    <label for="file">Choisir un logo</label> <span id="input_text_file"></span>
                                </div>
