...
<body>
                    ...
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item text-white active" aria-current="page">Outillage</li>
    ...
    <div class="wrapper">
        ...
        <form method="POST" action="tannonce3.php" enctype="multipart/form-data">

            <h4>Type</h4>
            <div class="input-group">
                <div class="input-box">
                    <select class="option" name="type" required>
                        <option selected>Choisi le Type de Matérial</option>
                        ...
                        <option>Informmatique et High-Tech</option>
                        <option>Equipement Auto</option>
                        <option>Jardinage</option>
                        <option>Matérial Bricollage</option>
                        <option>Matérial Tournage</option>
                        <option>Autre</option>
                    </select>
                </div>
            </div>
            ...
            <h4>Prix/Dhs/Jour</h4>
            <div class="input-box">
                <input type="number" placeholder="Prix" class="name" name="prix1" required>
            </div>
            <h4>Prix/Dhs/Semaine</h4>
            <div class="input-box">
                <input type="number" placeholder="Prix" class="name" name="prix2" required>
            </div>
            <h4>Prix/Dhs/Mois</h4>
            <div class="input-box">
                <input type="number" placeholder="Prix" class="name" name="prix3" required>
            </div>
