    ...
    <div class="wrap animate pop">
        <div class="overlay">
            <div class="overlay-content animate slide-left delay-2">
                <h5><?php echo $tableau['categorie']; ?></h5>
                <p class="animate slide-left pop delay-5" style="color: white; margin-bottom: 2.5rem;">Acteur: <em><?php echo $tableau['acteur']; ?></em></p>
            </div>
        ...
        <div class="text">
            <h5><?php echo $tableau['titre']; ?></h5>
            <p><?php echo $tableau['des1']; ?></p>
            <p><?php echo $tableau['des2']; ?></p>
        </div>
    </div>
